...
public class ContactSettingsActivity extends AppCompatActivity {
    ...
    //Method saves the last clicked filters by using SharedPreferences (initializes the activity)
    ...
    private void initSortByClick(){
        ...
        rgSortBy.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                ...
                if (rbName.isChecked() ){
                    getSharedPreferences("MyContactListPreferences", Context.MODE_PRIVATE).edit().putString("sortfield",
                            "contactname").apply();
                }
        ...
        rgSortOrder.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                ...
                if(rbAscending.isChecked()){
                    getSharedPreferences("MyContactListPreferences", Context.MODE_PRIVATE).edit().putString("sortorder",
                            "ASC").apply();
